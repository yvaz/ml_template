    ...
    query = """
        ...
        MAU30 AS (
            SELECT
                ...
                SUM(
                    MAP2_QR_TPV_AMT + MAP2_CHO_TPV_AMT + MAP2_AMML_TPV_AMT + MAP2_CRD_TPV_AMT + MAP2_TVC_TPV_AMT + MAP2_TVD_TPV_AMT
                ) AS TPV_COMPRAS_WEB,
                SUM(
                    MAP3_BP_TPV_AMT + MAP3_RCH_TPV_AMT + MAP3_SIG_TPV_AMT + MAP3_DON_TPV_AMT + MAP3_DD_TPV_AMT + MAP3_TRANSP_TPV_AMT + MAP3_PASE_TPV_AMT
                ) AS TPV_COMPRAS_APP,
                ...
                SUM(
                    MAP2_QR_TPN + MAP2_CHO_TPN + MAP2_AMML_TPN + MAP2_CRD_TPN + MAP2_TVC_TPN + MAP2_TVD_TPN
                ) AS TPN_COMPRAS_WEB,
                SUM(
                    MAP3_BP_TPN + MAP3_RCH_TPN + MAP3_SIG_TPN + MAP3_DON_TPN + MAP3_DD_TPN + MAP3_TRANSP_TPN + MAP3_PASE_TPN + MAP3_DIG_GOODS_TPN + MAP3_DELIVERY_TPN
                ) AS TPN_COMPRAS_APP,
                SUM(MAP4_INSR_TPN + MAP4_INVS_TPN + MAP4_CRIPTO_TPN) AS TPN_PRODUTOS_BANCARIOS,
                SUM(
